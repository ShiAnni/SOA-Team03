    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                int point=(Integer.parseInt(scoreElement.getTextContent()));
                String scoreType= scoreTypeElement.getTextContent();
                String courseNumber=courseNumberElement.getTextContent();
                String studentId1=studentIdElement.getTextContent();
                Score score=new Score(studentId1,courseNumber,scoreType,point) ;
