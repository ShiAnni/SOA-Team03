...
public class QueryParser {
    ...
    public static String path="D:\\大三（3）\\SOA\\git\\SOA-Team03\\assignment\\assignment6\\SOAWeb";
    ...
    public static List<Score> getObjectFromFile(){
        ...
        try {
            ...
            for(int i=0; i<list.getLength(); i++){
                ...
                int point=Integer.parseInt(strScore);//设置得分
                Element parent = (Element) n.getParentNode();
                String courseID=parent.getAttribute("课程编号");//设置课程编号
                String scoreType=parent.getAttribute("成绩性质");//设置成绩性质
                Score score=new Score(tempId,courseID,scoreType,point);
                result.add(score);
            }
            in.close();
        }catch (Exception e){
